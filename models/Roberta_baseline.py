...
def load_dataframes(data_dir, df_key):
    ...
    df = {}
    df["train"] = pd.read_pickle(os.path.join(data_dir, f"train_w_{df_key}.pkl"))
    df["valid"] = pd.read_pickle(os.path.join(data_dir, f"valid_w_{df_key}.pkl"))
    df["test"] = pd.read_pickle(os.path.join(data_dir, f"test_w_{df_key}.pkl"))
...
def main(args):
    ...
    df = load_dataframes(args.data_dir, args.df_key)
